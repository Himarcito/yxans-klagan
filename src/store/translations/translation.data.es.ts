export const translationsEs = {
  ...
  session: {
    ...
    who_or_what: {
      ...
      // Profesiones (Claves en inglés oficial y sinónimos comunes)
      druid: 'Druida',
      fighter: 'Guerrero',
      warrior: 'Guerrero', // Sinónimo común
      hunter: 'Cazador',
      minstrel: 'Juglar',
      bard: 'Bardo', // Sinónimo
      peddler: 'Buhonero',
      merchant: 'Mercader', // Sinónimo
      trader: 'Comerciante', // Sinónimo
      rider: 'Jinete',
      knight: 'Caballero', // Sinónimo
      rogue: 'Pícaro',
      thief: 'Ladrón', // Sinónimo
      sorcerer: 'Hechicero',
      mage: 'Mago', // Sinónimo
      wizard: 'Mago', // Sinónimo
      champion: 'Campeón', // De La Cuenca Glacial

      // Arquetipos y Roles Específicos (Causantes de errores)
      ...
      raven_sister: 'Hermana del Cuervo',
      iron_guard: 'Guardia de Hierro',
      spellbinder: 'Conjurador', // Término usado en algunas tablas
      apprentice: 'Aprendiz',
      master: 'Maestro',
      artisan: 'Artesano',
      smith: 'Herrero',
      ...
      // Criaturas y Entidades (A veces usadas como sujetos)
      monster: 'Monstruo',
      beast: 'Bestia',
      demon: 'Demonio',
      dragon: 'Dragón',
