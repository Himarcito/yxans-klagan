export const translationsEs = {
  ...
  session: {
    ...
    who_or_what: {
      ...
      priest: 'sacerdote',
      sorcerer: 'hechicero',
      robber_chief: 'jefe de una banda de ladrones',
      bandit_chief: 'jefe bandido',
      robber_chieftain: 'jefe bandido',
      warrior: 'guerrero',
      lord: 'señor',
      prince: 'príncipe',
      princess: 'princesa',
      queen: 'reina',
      king: 'rey',
      unit_of_soldiers: 'unidad de soldados',
    ...
    there_was: 'había un/una',
    who_searched: 'que buscaba',
    because_of: 'por',
    and_traveled_to: 'y viajó a',
    located: 'que se encontraba',
    in_the_direction_of: 'hacia el',
    as_the_legend_goes_it_is_said_that: 'Según la leyenda, se dice que',
    as_the_legend_goes_it_is_said_that_third: 'Según la leyenda, se dice que',
